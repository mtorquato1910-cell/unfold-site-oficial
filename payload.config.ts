...
import QuizQuestions from './src/collections/QuizQuestions.ts'
import InsightsVariations from './src/collections/InsightsVariations.ts'
import Leads from './src/collections/Leads.ts'
import DiagnosticoResults from './src/collections/DiagnosticoResults.ts'
import Posts from './src/collections/Posts.ts'
import Categories from './src/collections/Categories.ts'
import AIPrompts from './src/collections/AIPrompts.ts'
import AuditLog from './src/collections/AuditLog.ts'
