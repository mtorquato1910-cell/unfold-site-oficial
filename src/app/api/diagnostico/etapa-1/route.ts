      ...
      if (existing.docs.length > 0) {
        ...
        const lead = await payload.create({
          ...
          data: {
            ...
            empresa,
            cargo: cargo || '',
            tamanho_equipe: tamanho_equipe as unknown as '1-5' | '6-20' | '21-50' | '51-200' | '200+' | undefined,
            receita_anual: receita_anual as unknown as 'ate-1mm' | '1mm-5mm' | '5mm-20mm' | '20mm-100mm' | '100mm+' | undefined,
            origem: 'diagnostico',
