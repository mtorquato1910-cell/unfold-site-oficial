            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                {posts.map(post => (
                  ...
                  >
                    <td className="px-4 py-3 text-[13px] font-medium max-w-[220px] truncate" style={{ color: 'hsl(0 0% 91%)' }}>
                      {post.title || '—'}
                    </td>
                    <td className="px-4 py-3 text-[12px] font-mono text-dim hidden md:table-cell max-w-[180px] truncate">
                      {post.slug || '—'}
                    </td>
